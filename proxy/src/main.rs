...
fn main() {
    ...
    let upstreams: LoadBalancer<
        pingora::lb::selection::weighted::Weighted<pingora::lb::selection::algorithms::RoundRobin>,
    > = LoadBalancer::try_from_iter(["frontend:3000"]).unwrap();
